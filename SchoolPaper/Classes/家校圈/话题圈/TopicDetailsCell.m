...
@interface TDCell : UICollectionViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if ((self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])) {
        ...
        [_collectionView registerClass:[TDCell class] forCellWithReuseIdentifier:@"cell"];
...
{
    NSString *postName = [Base64 textFromBase64String:datas[@"boardName"]];
...
- (void)initWithImages:(NSDictionary *)datas
{
    ...
    NSArray *images = datas[@"boardImgs"];
...
- (void)initWithPlList:(NSDictionary *)datas
{
    ...
    if (talkNum) {
        ...
        {
            _plList.frame = CGRectMake(ScaleW(15), CGRectGetMaxY(_collectionView.frame) + ScaleH(10), DeviceW - ScaleW(30), tabHeight);
        }
        else
        {
            _plList.frame = CGRectMake(ScaleW(15), CGRectGetMaxY(_contentLb.frame) + ScaleH(10), DeviceW - ScaleW(30), tabHeight);
        }
                  ...
                  cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TDCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
    cell.backgroundColor = [UIColor clearColor];
    NSString * image = _datas[@"boardImgs"][indexPath.row];
